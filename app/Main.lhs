...
### my answers in [Haskell](https://www.haskell.org/) (see also [Kotlin branch](https://github.com/ephemient/aoc2019/tree/kt) and [Python branch](https://github.com/ephemient/aoc2019/tree/py))
