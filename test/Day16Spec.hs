...
spec = do
    ...
    describe "part 2'" $
        it "examples" $ do
            day16b "03036732577212944063491565474664" `shouldBe` "84462026"
            day16b "02935109699940807407585447034323" `shouldBe` "78725270"
            day16b "03081770884921959731165446850517" `shouldBe` "53553731"
