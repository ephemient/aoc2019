...
main = defaultMain
  ...
  , env (getDayInput 8) $ \input -> bgroup "Day 8"
      [ bench "part 1" $ nf (day8a 25 6) input
      , bench "part 2" $ nf (day8b 25 6) input
      ]
  ...
  , env (getDayInput 10) $ \input -> bgroup "Day 10"
      ...
      , bench "part 2" $ nf ((!! 199) . day10b) input
      ]
  ...
  , env (getDayInput 14) $ \input -> bgroup "Day 14"
      [ bench "part 1" $ nfIO $ day14a input
      , bench "part 2" $ nfIO $ day14b input
      ]
  ]
