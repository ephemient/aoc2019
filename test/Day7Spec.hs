...
spec = do
    ...
    describe "part 1" $ do
        it "example 1" $ do
            ...
            maxAmplify @IOArray mem [0..4] `shouldReturn` Just 43210
        it "example 2" $ do
            let mem = makeMem
                  [ 3, 23, 3, 24, 1002, 24, 10, 24, 1002, 23, -1, 23, 101, 5, 23
                  , 23, 1, 24, 23, 23, 4, 23, 99, 0, 0
                  ]
            maxAmplify @IOArray mem [0..4] `shouldReturn` Just 54321
        it "example 3" $ do
            let mem = makeMem
            ...
            maxAmplify @IOArray mem [0..4] `shouldReturn` Just 65210
    describe "part 2" $ do
        it "example 1" $ do
            let mem = makeMem
            ...
            maxAmplify @IOArray mem [5..9] `shouldReturn` Just 139629729
        it "example 2" $ do
            let mem = makeMem
            ...
            maxAmplify @IOArray mem [5..9] `shouldReturn` Just 18216
